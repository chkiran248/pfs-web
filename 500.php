...
<div style="text-align:center;max-width:480px;padding:2rem">
  ...
  <a href="<?= $site_url ?>/" style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.6rem 1.25rem;background:var(--mid);color:#fff;border-radius:7px;text-decoration:none;font-family:'DM Sans',sans-serif;font-size:0.875rem">← Go Home</a>
</div>
</body>
</html>
