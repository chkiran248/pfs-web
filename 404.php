...
<div style="text-align:center;max-width:480px;padding:2rem">
  ...
  <div style="display:flex;gap:0.75rem;justify-content:center">
    <a href="<?= $site_url ?>/" class="btn-primary" style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.6rem 1.25rem;background:var(--mid);color:#fff;border-radius:7px;text-decoration:none;font-family:'Inter',sans-serif;font-size:0.875rem">← Home</a>
    <a href="<?= $site_url ?>/portal/dashboard.php" style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.6rem 1.25rem;border:1px solid var(--lime);color:var(--lime);border-radius:7px;text-decoration:none;font-family:'Inter',sans-serif;font-size:0.875rem">Portal →</a>
  </div>
</div>
</body>
</html>
